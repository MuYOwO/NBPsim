...
namespace NBPsim_pe_utst
{
    ...
    public:
        ...
        TEST_METHOD(force_to_acceleration)
        {
            pe::Force<3> n{ 4.,6.,8. };
            pe::mass_t kg = 2.;
            pe::Acceleration<3> m_s2_result = pe::Physics<3>::to_acceleration(n, kg);
        ...
        TEST_METHOD(acceleration_to_delta_velocity)
        {
            ...
            pe::time_t s = 2.;
            pe::Velocity<3> m_s_result = pe::Physics<3>::to_delta_velocity(m_s2, s);
        ...
        TEST_METHOD(velocity_to_displacement)
        {
            ...
            pe::time_t s = 2.;
            pe::Displacement<3> m_result = pe::Physics<3>::to_displacement(m_s, s);
