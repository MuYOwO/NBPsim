...
namespace NBPsim_pe_utst
{
    ...
    public:
        ...
        TEST_METHOD(vector_t_arg_constructor)
        {
            ...
            pe::Acceleration<3> b(std::move(u));
        ...
        TEST_METHOD(retrieve_nonconst_component_reference)
        {
            ...
            pe::Acceleration<3>::component_type& a_2_ref_0 = a[2];
            pe::Acceleration<3>::component_type& a_2_ref_1 = a.get<2>();
        ...
        {
            pe::Acceleration<3> a{ 10.,10.,10. };
            pe::Acceleration<3> b{ 1.,2.,3. };
            a += b;
        ...
        {
            pe::Acceleration<3> a{ 3.,6.,9. };

            pe::Acceleration<3> b(-a);
            Assert::AreEqual(-3., b.get<0>());
            Assert::AreEqual(-6., b.get<1>());
            Assert::AreEqual(-9., b.get<2>());

            pe::Acceleration<3> c(a.opposite());
        ...
        {
            pe::Acceleration<3> a{ 10.,11.,22. };
            pe::Acceleration<3> b = a;
            pe::Acceleration<3> c = { 1.,2.,3. };
            Assert::IsTrue(a == b);
            Assert::IsTrue(a != c);
        }
    };
