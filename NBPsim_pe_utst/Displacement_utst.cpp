...
namespace NBPsim_pe_utst
{
    ...
    public:
        ...
        TEST_METHOD(norm_squared_and_norm)
        {
            ...
            pe::Displacement<3>::component_type actual_norm_squared = 2.*2. + 3.*3. + 4.*4.;
            pe::Displacement<3>::component_type actual_norm = ::sqrt(actual_norm_squared);
        ...
        {
            pe::Displacement<3> a{ 2.,3.,4. };
            pe::Displacement<3> u = a.unit_vector();
            pe::Displacement<3>::component_type actual_norm_squared = 2.*2. + 3.*3. + 4.*4.;
            pe::Displacement<3>::component_type actual_norm = ::sqrt(actual_norm_squared);
        ...
        {
            pe::Displacement<3> a{ 12.,16.,18. };
            pe::Displacement<3> b = a * 2.;
            pe::Displacement<3> c = 3. * a;
